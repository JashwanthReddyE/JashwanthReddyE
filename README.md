...
- [jashwanthreddyearla@gmail.com](mailto:jashwanthreddyearla@gmail.com) · [LinkedIn](https://www.linkedin.com/in/jrearla/) · [Portfolio](https://jashwanthreddye.github.io)
...
|---|---|---|
| [**AISLakehouse**](https://github.com/JashwanthReddyE/AISLakehouse) · [live ↗](https://aislakehouse.vercel.app/) | Real-time maritime **lakehouse**. A 24/7 Container Apps consumer reads a live global ship-position feed (AISStream WebSocket) into **Event Hubs**, then **Databricks Structured Streaming** builds a Delta **medallion** on ADLS Gen2 — Bronze (exactly-once via checkpointing) → Silver (watermarked dedup, MMSI→flag, DQ quarantine) → Gold **dark-vessel detection** + a tanker-flow / floating-storage commodity indicator. Hourly GitHub Action re-runs the pipeline and redeploys a glassmorphism Vercel dashboard. 86 pytest cases. | Python 3.11 · Azure Event Hubs · Databricks · Spark Structured Streaming · Delta Lake · ADLS Gen2 · Unity Catalog · Container Apps · Bicep · Vercel |
...
| [**JashwanthReddyE.github.io**](https://github.com/JashwanthReddyE/JashwanthReddyE.github.io) · [live ↗](https://jashwanthreddye.github.io) | Current portfolio site — architecture diagrams, wins-with-numbers, and deep-dives on the AISLakehouse, Crypto Sentinel, and AWS stock-sentiment pipelines. | HTML · CSS · Vanilla JS |
